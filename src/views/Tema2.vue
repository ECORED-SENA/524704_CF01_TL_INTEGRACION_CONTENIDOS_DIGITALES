<template lang="pug">
  .curso-main-container.pb-3
    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      p.mb-5(data-aos="fade-right") De igual manera, el diseño digital puede entenderse como el enfoque encargado de #[b dar solución a problemas reales derivados de la interacción entre las personas y la presencia digital de las empresas], especialmente en el desarrollo de páginas #[i web]. A partir de estas aproximaciones, la definición que mejor se ajusta a los contenidos formativos del programa tecnológico #[b Técnico en Integración de Contenidos Digitales] es la siguiente:
      ...
      p.mb-5(data-aos="fade-right") Al diseñar un sitio #[i web], es necesario considerar ciertos principios clave que permiten que el usuario pueda realizar correctamente las actividades y procesos previstos por el diseñador. Estos principios se conocen como #[b principios de diseño #[i web]].
      ...
      .color___box_2
        .px-5
          ...
          p.mb-5(data-aos="fade-right") El diseño y la arquitectura de información de las páginas #[i web] son “el resultado de la actividad de clasificar, describir, estructurar y etiquetar los contenidos del sitio” (Leyva, Alarcón, Barrera y Ortegón, 2017). Antes de proyectar o diseñar una página #[i web], es necesario seguir los lineamientos de la etapa de creación, tal como se presenta:
          .fondo___slider.mb-5
            .px-5
      ...
      p.mb-5(data-aos="fade-right") Para la estructuración visual inicial de un sitio #[i web] se emplean herramientas de bocetación como el #[i wireframe] y el #[i mockup]: 
